...
import { ChevronLeft, ChevronRight, Waves, Sparkles, Heart, Flower, Droplet } from "lucide-react";
...
const SpaDevicesCarousel = () => {
  ...
  const devices = [
    ...
    },
    {
      ...
      features: ["Minimalistisch design", "JetPak®-massages", "Efficiënte filtratie", "LED-verlichting"],
